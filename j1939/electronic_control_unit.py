...
class ElectronicControlUnit:
    ...
    def notify(self, can_id, data, timestamp, channel):
        ...
        """
        self.j1939_dll.notify(can_id, data, timestamp, channel)
    ...
    def _notify_subscribers(self, priority, pgn, sa, dest, timestamp, data, channel):
        ...
        for dic in self._subscribers:
            if (
                ...
                dic["cb"](priority, pgn, sa, timestamp, data, channel)
...
class MessageListener(Listener):
    ...
    def on_message_received(self, msg: can.Message):
        ...
        try:
            ...
            """
            self.ecu.notify(msg.arbitration_id, msg.data, msg.timestamp, msg.channel)
